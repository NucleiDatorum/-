...
| 02 | [games_that_people_buy](https://github.com/NucleiDatorum/Portfolio/blob/main/games_that_people_buy.ipynb) | | `python` `pandas` `numpy` `matplotlib` `seaborn` `plotly` `scipy` |
| 03 | []() | | |
